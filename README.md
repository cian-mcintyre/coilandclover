...
Mercedes website of the future. 

Images generated using Midjourney

Original UI using Klarna Template

SoW: 
User able to Register an account
User able to log in
Users able to place an order and receive a tracking number
Users able to browse by category/colour/type
A User being able to log in and see their order they placed
